...
TUNABLE_PARAM(Search_correction_history_bonus_1, 10, 0, 24)
TUNABLE_PARAM(Search_correction_history_bonus_2, 15, 0, 34)
TUNABLE_PARAM(Search_correction_history_bonus_3, 1512, 0, 2138)
TUNABLE_PARAM(Search_fail_low_capture_bonus_1, 713, 0, 2036)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_1, -59, -464, 0)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_2, 89, 1, 216)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_3, 19, 0, 118)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_4, 583, 0, 908)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_5, 303, 0, 338)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_6, 9, 0, 16)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_7, 167, 0, 290)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_8, 145, 0, 220)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_9, 232, 0, 308)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_10, 80, 0, 146)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_11, 198, 0, 270)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_12, 30, 0, 160)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_13, 1881, 0, 2800)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_14, 255, 0, 442)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_15, 335, 0, 470)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_16, 423, 0, 580)
TUNABLE_PARAM(Search_LMR_research_thresholds_1, 43, 0, 96)
TUNABLE_PARAM(Search_LMR_research_thresholds_2, 15, 0, 18)
TUNABLE_PARAM(Search_All_node_reduction_scale_1, 298, 0, 546)
TUNABLE_PARAM(Search_Capture_SEE_pruning_margin_1, 300, 0, 334)
TUNABLE_PARAM(Search_Capture_SEE_pruning_margin_2, 44, 0, 68)
TUNABLE_PARAM(Search_IIR_1, 4, 0, 12)
TUNABLE_PARAM(Search_IIR_2, 3, 0, 6)
TUNABLE_PARAM(Search_nullmove_2_1, 9, 0, 14)
TUNABLE_PARAM(YaneuraOuWorker_clear1_1, -724, -1356, 0)
TUNABLE_PARAM(YaneuraOuWorker_clear1_2, -1671, -2476, 0)
TUNABLE_PARAM(YaneuraOuWorker_clear1_3, 12, 0, 12)
TUNABLE_PARAM(update_quiet_histories_2b_1, 666, 0, 1678)
TUNABLE_PARAM(update_quiet_histories_2b_2, 1044, 0, 1100)
TUNABLE_PARAM(update_quiet_histories_1a_1, 345, 0, 1748)
TUNABLE_PARAM(update_quiet_histories_1a_2, 1050, 0, 1688)
TUNABLE_PARAM(conthist_bonuses_1, 867, 0, 1982)
TUNABLE_PARAM(conthist_bonuses_2, 889, 0, 1360)
TUNABLE_PARAM(conthist_bonuses_3, 306, 0, 566)
TUNABLE_PARAM(conthist_bonuses_4, 667, 0, 1334)
TUNABLE_PARAM(conthist_bonuses_5, 189, 0, 280)
TUNABLE_PARAM(conthist_bonuses_6, 549, 0, 1786)
TUNABLE_PARAM(update_all_stats_1c_1, 115, 0, 392)
TUNABLE_PARAM(update_all_stats_1c_2, 96, 0, 154)
TUNABLE_PARAM(update_all_stats_1c_3, 1201, 0, 3058)
TUNABLE_PARAM(update_all_stats_1c_4, 542, 0, 1100)
TUNABLE_PARAM(update_all_stats_1c_5, 608, 0, 962)
TUNABLE_PARAM(update_all_stats_1c_6, 150, 0, 410)
TUNABLE_PARAM(update_all_stats_1c_7, 1921, 0, 4244)
TUNABLE_PARAM(YaneuraOuWorker_reduction_1, 829, 0, 1524)
TUNABLE_PARAM(YaneuraOuWorker_reduction_2, 190, 0, 644)
TUNABLE_PARAM(YaneuraOuWorker_reduction_3, 975, 0, 2698)
TUNABLE_PARAM(Search_standPat_1, 341, 0, 656)
TUNABLE_PARAM(Search_ttMoveHistoryBonus_1, 636, 0, 1316)
TUNABLE_PARAM(Search_ttMoveHistoryBonus_2, -1120, -1724, 0)
TUNABLE_PARAM(Search_Full_depth_search_threshold_2b_1, 4265, 0, 5058)
TUNABLE_PARAM(Search_Full_depth_search_threshold_2b_2, 4032, 0, 7400)
TUNABLE_PARAM(Search_Full_depth_search_threshold_1a_1, 1024, 0, 2442)
TUNABLE_PARAM(Search_Post_LMR_continuation_history_updates_1, 833, 0, 1600)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_9_1, 421, 0, 746)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_8_1, 1136, 0, 1732)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_7_1, 3384, 0, 3452)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_6a_1, 220, 0, 502)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_6a_2, 1238, 0, 2980)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_6a_3, 1051, 0, 1274)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_5_1, 394, 0, 3086)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_4_1, 3042, 0, 4558)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_4_2, 1642, 0, 3020)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_3_1, 15, 0, 26)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_3_2, 35802, 1, 56294)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_2_1, 945, 0, 2064)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_1_1, 2567, 0, 4472)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_1_2, 1137, 0, 2408)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_1_3, 863, 0, 882)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_1_4, 1757, 0, 1870)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_1_5, 952, 0, 2542)
TUNABLE_PARAM(Search_Extensions4_1, 112, 0, 232)
TUNABLE_PARAM(Search_Extensions4_2, 333, 0, 798)
TUNABLE_PARAM(Search_Extensions4_3, 256, 0, 436)
TUNABLE_PARAM(Search_Extensions4_4, 126, 0, 238)
TUNABLE_PARAM(Search_Extensions4_5, 58, 0, 76)
TUNABLE_PARAM(Search_Extensions3_1, -4, -8, 6)
TUNABLE_PARAM(Search_Extensions3_2, 276, 0, 390)
TUNABLE_PARAM(Search_Extensions3_3, 324, 0, 492)
TUNABLE_PARAM(Search_Extensions3_4, 931, 0, 1662)
TUNABLE_PARAM(Search_Extensions3_5, 52, 0, 88)
TUNABLE_PARAM(Search_Extensions2_1, 211538, 1, 556130)
TUNABLE_PARAM(Search_Extensions1_1, 89, 0, 146)
TUNABLE_PARAM(Search_Extensions1_2, 80, 0, 234)
TUNABLE_PARAM(Search_Extensions1_3, 62, 1, 66)
TUNABLE_PARAM(Search_Continuation_history_based_pruning3_1, -38, -82, 0)
TUNABLE_PARAM(Search_Continuation_history_based_pruning2_1, 43, 0, 120)
TUNABLE_PARAM(Search_Continuation_history_based_pruning2_2, 55, 0, 154)
TUNABLE_PARAM(Search_Continuation_history_based_pruning1_1, -2292, -7822, 0)
TUNABLE_PARAM(Search_Continuation_history_based_pruning1_2, 36, 0, 72)
TUNABLE_PARAM(Search_Continuation_history_based_pruning1_3, 2185, 1, 7186)
TUNABLE_PARAM(Search_futility_value_1, 244, 0, 766)
TUNABLE_PARAM(Search_futility_value_2, 309, 0, 810)
TUNABLE_PARAM(Search_futility_value_3, 169, 0, 290)
TUNABLE_PARAM(Search_decrease_reduction_for_tt_pv_1, 1182, 0, 2026)
TUNABLE_PARAM(Search_small_Probcut_1, 380, 0, 484)
TUNABLE_PARAM(Search_Probcut_1, 170, 0, 256)
TUNABLE_PARAM(Search_Probcut_2, 76, 0, 158)
TUNABLE_PARAM(Search_nullmove_1_1, 24, 0, 44)
TUNABLE_PARAM(Search_nullmove_1_2, 58, 0, 106)
TUNABLE_PARAM(Search_nullmove_1_3, 287, 0, 556)
TUNABLE_PARAM(Search_futility_1_1, 94, 0, 152)
TUNABLE_PARAM(Search_futility_1_2, 21, 0, 48)
TUNABLE_PARAM(Search_futility_1_3, 2078, 0, 5372)
TUNABLE_PARAM(Search_futility_1_4, 470, 0, 724)
TUNABLE_PARAM(Search_futility_1_5, 87681, 1, 183406)
TUNABLE_PARAM(Search_razoring_1, 328, 0, 736)
TUNABLE_PARAM(Search_razoring_2, 241, 0, 550)
TUNABLE_PARAM(Search_static_evaluation3_1, 181, 0, 396)
TUNABLE_PARAM(Search_static_evaluation_2a_1, 2935, 0, 6656)
TUNABLE_PARAM(Search_static_evaluation_1a_1, -62865, -167424, 0)
TUNABLE_PARAM(Search_static_evaluation_1a_2, 48788, 0, 79872)
TUNABLE_PARAM(Search_static_evaluation_1a_3, 8686, 0, 19968)
TUNABLE_PARAM(Search_static_evaluation_1a_4, 774, 0, 2560)
TUNABLE_PARAM(Search_tt_lookup2_1, -1963, -2354, 0)
TUNABLE_PARAM(Search_tt_lookup1_1, 48, 0, 58)
TUNABLE_PARAM(Search_tt_lookup1_2, 50, 0, 174)
TUNABLE_PARAM(Search_tt_lookup1_3, 697, 0, 2010)
TUNABLE_PARAM(YaneuraOuWorker_clear3_1, 2773, 0, 5520)
TUNABLE_PARAM(YaneuraOuWorker_clear2_1, -603, -1326, 0)
TUNABLE_PARAM(aspiration_window_1, 8, 0, 46)
TUNABLE_PARAM(aspiration_window_2, 5036, 1, 13584)
TUNABLE_PARAM(lowPlyHistory_fill_1, 77, 0, 168)
TUNABLE_PARAM(update_correction_history2_1, 171, 0, 240)
TUNABLE_PARAM(update_correction_history2_2, 33, 0, 110)
TUNABLE_PARAM(update_correction_history1_1, 244, 0, 362)
TUNABLE_PARAM(update_correction_history_nonPawnWeight_1, 145, 0, 324)
TUNABLE_PARAM(correction_value_1, 9011, 0, 14988)
TUNABLE_PARAM(correction_value_2, 7728, 0, 14846)
TUNABLE_PARAM(correction_value_3, 9124, 0, 21950)
TUNABLE_PARAM(correction_value_4, 14827, 0, 28062)
