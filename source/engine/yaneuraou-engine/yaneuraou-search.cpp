...
//                            %%TUNE_DECLARATION%%
// SPSAで調整する探索パラメーター。
TUNABLE_PARAM(QSearch_SEE_pruning_1, -64, -146, 0)
...
TUNABLE_PARAM(Search_correction_history_bonus_3, 1175, 0, 2138)
TUNABLE_PARAM(Search_fail_low_capture_bonus_1, 1385, 0, 2036)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_1, -200, -464, 0)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_2, 72, 1, 216)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_3, 73, 0, 118)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_4, 414, 0, 908)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_5, 168, 0, 338)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_6, 8, 0, 16)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_7, 130, 0, 290)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_8, 85, 0, 220)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_9, 143, 0, 308)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_10, 69, 0, 146)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_11, 157, 0, 270)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_12, 53, 0, 160)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_13, 1280, 0, 2800)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_14, 275, 0, 442)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_15, 246, 0, 470)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_16, 239, 0, 580)
TUNABLE_PARAM(Search_LMR_research_thresholds_1, 54, 0, 96)
TUNABLE_PARAM(Search_LMR_research_thresholds_2, 10, 0, 18)
TUNABLE_PARAM(Search_All_node_reduction_scale_1, 247, 0, 546)
TUNABLE_PARAM(Search_Capture_SEE_pruning_margin_1, 152, 0, 334)
TUNABLE_PARAM(Search_Capture_SEE_pruning_margin_2, 38, 0, 68)
TUNABLE_PARAM(Search_IIR_1, 5, 0, 12)
TUNABLE_PARAM(Search_IIR_2, 3, 0, 6)
TUNABLE_PARAM(Search_nullmove_2_1, 8, 0, 14)
TUNABLE_PARAM(YaneuraOuWorker_clear1_1, -714, -1356, 0)
TUNABLE_PARAM(YaneuraOuWorker_clear1_2, -1462, -2476, 0)
TUNABLE_PARAM(YaneuraOuWorker_clear1_3, 6, 0, 12)
TUNABLE_PARAM(update_quiet_histories_2b_1, 740, 0, 1678)
TUNABLE_PARAM(update_quiet_histories_2b_2, 543, 0, 1100)
TUNABLE_PARAM(update_quiet_histories_1a_1, 774, 0, 1748)
TUNABLE_PARAM(update_quiet_histories_1a_2, 732, 0, 1688)
TUNABLE_PARAM(conthist_bonuses_1, 1110, 0, 1982)
TUNABLE_PARAM(conthist_bonuses_2, 679, 0, 1360)
TUNABLE_PARAM(conthist_bonuses_3, 367, 0, 566)
TUNABLE_PARAM(conthist_bonuses_4, 940, 0, 1334)
TUNABLE_PARAM(conthist_bonuses_5, 89, 0, 280)
TUNABLE_PARAM(conthist_bonuses_6, 992, 0, 1786)
TUNABLE_PARAM(update_all_stats_1c_1, 222, 0, 392)
TUNABLE_PARAM(update_all_stats_1c_2, 51, 0, 154)
TUNABLE_PARAM(update_all_stats_1c_3, 1434, 0, 3058)
TUNABLE_PARAM(update_all_stats_1c_4, 711, 0, 1100)
TUNABLE_PARAM(update_all_stats_1c_5, 598, 0, 962)
TUNABLE_PARAM(update_all_stats_1c_6, 196, 0, 410)
TUNABLE_PARAM(update_all_stats_1c_7, 1965, 0, 4244)
TUNABLE_PARAM(YaneuraOuWorker_reduction_1, 825, 0, 1524)
TUNABLE_PARAM(YaneuraOuWorker_reduction_2, 376, 0, 644)
TUNABLE_PARAM(YaneuraOuWorker_reduction_3, 1321, 0, 2698)
TUNABLE_PARAM(Search_standPat_1, 111, 0, 656)
TUNABLE_PARAM(Search_ttMoveHistoryBonus_1, 814, 0, 1316)
TUNABLE_PARAM(Search_ttMoveHistoryBonus_2, -709, -1724, 0)
TUNABLE_PARAM(Search_Full_depth_search_threshold_2b_1, 2752, 0, 5058)
TUNABLE_PARAM(Search_Full_depth_search_threshold_2b_2, 4586, 0, 7400)
TUNABLE_PARAM(Search_Full_depth_search_threshold_1a_1, 1065, 0, 2442)
TUNABLE_PARAM(Search_Post_LMR_continuation_history_updates_1, 671, 0, 1600)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_9_1, 389, 0, 746)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_8_1, 1095, 0, 1732)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_7_1, 1859, 0, 3452)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_6a_1, 267, 0, 502)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_6a_2, 1522, 0, 2980)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_6a_3, 551, 0, 1274)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_5_1, 1603, 0, 3086)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_4_1, 2121, 0, 4558)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_4_2, 1236, 0, 3020)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_3_1, 12, 0, 26)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_3_2, 26933, 1, 56294)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_2_1, 1002, 0, 2064)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_1_1, 2242, 0, 4472)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_1_2, 1454, 0, 2408)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_1_3, 490, 0, 882)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_1_4, 957, 0, 1870)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_1_5, 1154, 0, 2542)
TUNABLE_PARAM(Search_Extensions4_1, 76, 0, 232)
TUNABLE_PARAM(Search_Extensions4_2, 359, 0, 798)
TUNABLE_PARAM(Search_Extensions4_3, 35, 0, 436)
TUNABLE_PARAM(Search_Extensions4_4, 124, 0, 238)
TUNABLE_PARAM(Search_Extensions4_5, 47, 0, 76)
TUNABLE_PARAM(Search_Extensions3_1, 2, -8, 6)
TUNABLE_PARAM(Search_Extensions3_2, 229, 0, 390)
TUNABLE_PARAM(Search_Extensions3_3, 261, 0, 492)
TUNABLE_PARAM(Search_Extensions3_4, 746, 0, 1662)
TUNABLE_PARAM(Search_Extensions3_5, 18, 0, 88)
TUNABLE_PARAM(Search_Extensions2_1, 242929, 1, 556130)
TUNABLE_PARAM(Search_Extensions1_1, 85, 0, 146)
TUNABLE_PARAM(Search_Extensions1_2, 85, 0, 234)
TUNABLE_PARAM(Search_Extensions1_3, 33, 1, 66)
TUNABLE_PARAM(Search_Continuation_history_based_pruning3_1, -47, -82, 0)
...
TUNABLE_PARAM(Search_Continuation_history_based_pruning1_1, -3341, -7822, 0)
TUNABLE_PARAM(Search_Continuation_history_based_pruning1_2, 36, 0, 72)
TUNABLE_PARAM(Search_Continuation_history_based_pruning1_3, 3728, 1, 7186)
TUNABLE_PARAM(Search_futility_value_1, 437, 0, 766)
TUNABLE_PARAM(Search_futility_value_2, 368, 0, 810)
TUNABLE_PARAM(Search_futility_value_3, 107, 0, 290)
TUNABLE_PARAM(Search_decrease_reduction_for_tt_pv_1, 352, 0, 2026)
TUNABLE_PARAM(Search_small_Probcut_1, 131, 0, 484)
TUNABLE_PARAM(Search_Probcut_1, 119, 0, 256)
TUNABLE_PARAM(Search_Probcut_2, 80, 0, 158)
TUNABLE_PARAM(Search_nullmove_1_1, 23, 0, 44)
TUNABLE_PARAM(Search_nullmove_1_2, 61, 0, 106)
TUNABLE_PARAM(Search_nullmove_1_3, 232, 0, 556)
TUNABLE_PARAM(Search_futility_1_1, 33, 0, 152)
TUNABLE_PARAM(Search_futility_1_2, 28, 0, 48)
TUNABLE_PARAM(Search_futility_1_3, 2220, 0, 5372)
TUNABLE_PARAM(Search_futility_1_4, 479, 0, 724)
TUNABLE_PARAM(Search_futility_1_5, 79990, 1, 183406)
TUNABLE_PARAM(Search_razoring_1, 221, 0, 736)
TUNABLE_PARAM(Search_razoring_2, 179, 0, 550)
TUNABLE_PARAM(Search_static_evaluation3_1, 197, 0, 396)
TUNABLE_PARAM(Search_static_evaluation_2a_1, 3708, 0, 6656)
TUNABLE_PARAM(Search_static_evaluation_1a_1, -44411, -167424, 0)
TUNABLE_PARAM(Search_static_evaluation_1a_2, 20704, 0, 79872)
TUNABLE_PARAM(Search_static_evaluation_1a_3, 11013, 0, 19968)
TUNABLE_PARAM(Search_static_evaluation_1a_4, 1328, 0, 2560)
TUNABLE_PARAM(Search_tt_lookup2_1, -1186, -2354, 0)
TUNABLE_PARAM(Search_tt_lookup1_1, 29, 0, 58)
TUNABLE_PARAM(Search_tt_lookup1_2, 93, 0, 174)
TUNABLE_PARAM(Search_tt_lookup1_3, 1216, 0, 2010)
TUNABLE_PARAM(YaneuraOuWorker_clear3_1, 2938, 0, 5520)
TUNABLE_PARAM(YaneuraOuWorker_clear2_1, -766, -1326, 0)
TUNABLE_PARAM(aspiration_window_1, 30, 0, 46)
TUNABLE_PARAM(aspiration_window_2, 7904, 1, 13584)
TUNABLE_PARAM(lowPlyHistory_fill_1, 75, 0, 168)
TUNABLE_PARAM(update_correction_history2_1, 111, 0, 240)
TUNABLE_PARAM(update_correction_history2_2, 69, 0, 110)
TUNABLE_PARAM(update_correction_history1_1, 192, 0, 362)
TUNABLE_PARAM(update_correction_history_nonPawnWeight_1, 135, 0, 324)
TUNABLE_PARAM(correction_value_1, 6282, 0, 14988)
TUNABLE_PARAM(correction_value_2, 5894, 0, 14846)
TUNABLE_PARAM(correction_value_3, 8677, 0, 21950)
TUNABLE_PARAM(correction_value_4, 13614, 0, 28062)
