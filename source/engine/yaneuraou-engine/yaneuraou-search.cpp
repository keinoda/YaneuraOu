...
//                            %%TUNE_DECLARATION%%
// SPSAで調整する探索パラメーター。
TUNABLE_PARAM(QSearch_SEE_pruning_1, -63, -146, 0)
...
TUNABLE_PARAM(Search_correction_history_bonus_3, 1263, 0, 2138)
TUNABLE_PARAM(Search_fail_low_capture_bonus_1, 1362, 0, 2036)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_1, -198, -464, 0)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_2, 74, 1, 216)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_3, 72, 0, 118)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_4, 359, 0, 908)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_5, 186, 0, 338)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_6, 7, 0, 16)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_7, 133, 0, 290)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_8, 83, 0, 220)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_9, 153, 0, 308)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_10, 70, 0, 146)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_11, 135, 0, 270)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_12, 47, 0, 160)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_13, 1338, 0, 2800)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_14, 292, 0, 442)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_15, 232, 0, 470)
TUNABLE_PARAM(Search_fail_low_quiet_bonus_16, 261, 0, 580)
TUNABLE_PARAM(Search_LMR_research_thresholds_1, 50, 0, 96)
TUNABLE_PARAM(Search_LMR_research_thresholds_2, 10, 0, 18)
TUNABLE_PARAM(Search_All_node_reduction_scale_1, 209, 0, 546)
TUNABLE_PARAM(Search_Capture_SEE_pruning_margin_1, 143, 0, 334)
TUNABLE_PARAM(Search_Capture_SEE_pruning_margin_2, 40, 0, 68)
TUNABLE_PARAM(Search_IIR_1, 5, 0, 12)
TUNABLE_PARAM(Search_IIR_2, 3, 0, 6)
TUNABLE_PARAM(Search_nullmove_2_1, 8, 0, 14)
TUNABLE_PARAM(YaneuraOuWorker_clear1_1, -782, -1356, 0)
TUNABLE_PARAM(YaneuraOuWorker_clear1_2, -1264, -2476, 0)
TUNABLE_PARAM(YaneuraOuWorker_clear1_3, 7, 0, 12)
TUNABLE_PARAM(update_quiet_histories_2b_1, 914, 0, 1678)
TUNABLE_PARAM(update_quiet_histories_2b_2, 604, 0, 1100)
TUNABLE_PARAM(update_quiet_histories_1a_1, 751, 0, 1748)
TUNABLE_PARAM(update_quiet_histories_1a_2, 820, 0, 1688)
TUNABLE_PARAM(conthist_bonuses_1, 1095, 0, 1982)
TUNABLE_PARAM(conthist_bonuses_2, 687, 0, 1360)
TUNABLE_PARAM(conthist_bonuses_3, 326, 0, 566)
TUNABLE_PARAM(conthist_bonuses_4, 975, 0, 1334)
TUNABLE_PARAM(conthist_bonuses_5, 103, 0, 280)
TUNABLE_PARAM(conthist_bonuses_6, 1086, 0, 1786)
TUNABLE_PARAM(update_all_stats_1c_1, 248, 0, 392)
TUNABLE_PARAM(update_all_stats_1c_2, 43, 0, 154)
TUNABLE_PARAM(update_all_stats_1c_3, 1455, 0, 3058)
TUNABLE_PARAM(update_all_stats_1c_4, 688, 0, 1100)
TUNABLE_PARAM(update_all_stats_1c_5, 669, 0, 962)
TUNABLE_PARAM(update_all_stats_1c_6, 198, 0, 410)
TUNABLE_PARAM(update_all_stats_1c_7, 2240, 0, 4244)
TUNABLE_PARAM(YaneuraOuWorker_reduction_1, 798, 0, 1524)
TUNABLE_PARAM(YaneuraOuWorker_reduction_2, 396, 0, 644)
TUNABLE_PARAM(YaneuraOuWorker_reduction_3, 1076, 0, 2698)
TUNABLE_PARAM(Search_standPat_1, 97, 0, 656)
TUNABLE_PARAM(Search_ttMoveHistoryBonus_1, 738, 0, 1316)
TUNABLE_PARAM(Search_ttMoveHistoryBonus_2, -645, -1724, 0)
TUNABLE_PARAM(Search_Full_depth_search_threshold_2b_1, 2725, 0, 5058)
TUNABLE_PARAM(Search_Full_depth_search_threshold_2b_2, 4752, 0, 7400)
TUNABLE_PARAM(Search_Full_depth_search_threshold_1a_1, 1077, 0, 2442)
TUNABLE_PARAM(Search_Post_LMR_continuation_history_updates_1, 596, 0, 1600)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_9_1, 462, 0, 746)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_8_1, 1096, 0, 1732)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_7_1, 2006, 0, 3452)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_6a_1, 229, 0, 502)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_6a_2, 1453, 0, 2980)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_6a_3, 594, 0, 1274)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_5_1, 1625, 0, 3086)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_4_1, 2127, 0, 4558)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_4_2, 1260, 0, 3020)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_3_1, 13, 0, 26)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_3_2, 29252, 1, 56294)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_2_1, 939, 0, 2064)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_1_1, 2445, 0, 4472)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_1_2, 1360, 0, 2408)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_1_3, 469, 0, 882)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_1_4, 843, 0, 1870)
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_1_5, 1183, 0, 2542)
TUNABLE_PARAM(Search_Extensions4_1, 71, 0, 232)
TUNABLE_PARAM(Search_Extensions4_2, 373, 0, 798)
TUNABLE_PARAM(Search_Extensions4_3, 0, 0, 436)
TUNABLE_PARAM(Search_Extensions4_4, 133, 0, 238)
TUNABLE_PARAM(Search_Extensions4_5, 49, 0, 76)
TUNABLE_PARAM(Search_Extensions3_1, 2, -8, 6)
TUNABLE_PARAM(Search_Extensions3_2, 205, 0, 390)
TUNABLE_PARAM(Search_Extensions3_3, 250, 0, 492)
TUNABLE_PARAM(Search_Extensions3_4, 769, 0, 1662)
TUNABLE_PARAM(Search_Extensions3_5, 20, 0, 88)
TUNABLE_PARAM(Search_Extensions2_1, 278750, 1, 556130)
TUNABLE_PARAM(Search_Extensions1_1, 70, 0, 146)
TUNABLE_PARAM(Search_Extensions1_2, 76, 0, 234)
TUNABLE_PARAM(Search_Extensions1_3, 35, 1, 66)
TUNABLE_PARAM(Search_Continuation_history_based_pruning3_1, -45, -82, 0)
TUNABLE_PARAM(Search_Continuation_history_based_pruning2_1, 58, 0, 120)
TUNABLE_PARAM(Search_Continuation_history_based_pruning2_2, 65, 0, 154)
TUNABLE_PARAM(Search_Continuation_history_based_pruning1_1, -3971, -7822, 0)
TUNABLE_PARAM(Search_Continuation_history_based_pruning1_2, 38, 0, 72)
TUNABLE_PARAM(Search_Continuation_history_based_pruning1_3, 3712, 1, 7186)
TUNABLE_PARAM(Search_futility_value_1, 492, 0, 766)
TUNABLE_PARAM(Search_futility_value_2, 371, 0, 810)
TUNABLE_PARAM(Search_futility_value_3, 132, 0, 290)
TUNABLE_PARAM(Search_decrease_reduction_for_tt_pv_1, 299, 0, 2026)
TUNABLE_PARAM(Search_small_Probcut_1, 144, 0, 484)
TUNABLE_PARAM(Search_Probcut_1, 139, 0, 256)
TUNABLE_PARAM(Search_Probcut_2, 80, 0, 158)
TUNABLE_PARAM(Search_nullmove_1_1, 22, 0, 44)
TUNABLE_PARAM(Search_nullmove_1_2, 59, 0, 106)
TUNABLE_PARAM(Search_nullmove_1_3, 236, 0, 556)
TUNABLE_PARAM(Search_futility_1_1, 48, 0, 152)
TUNABLE_PARAM(Search_futility_1_2, 26, 0, 48)
TUNABLE_PARAM(Search_futility_1_3, 2024, 0, 5372)
TUNABLE_PARAM(Search_futility_1_4, 467, 0, 724)
TUNABLE_PARAM(Search_futility_1_5, 75964, 1, 183406)
TUNABLE_PARAM(Search_razoring_1, 209, 0, 736)
TUNABLE_PARAM(Search_razoring_2, 177, 0, 550)
TUNABLE_PARAM(Search_static_evaluation3_1, 184, 0, 396)
TUNABLE_PARAM(Search_static_evaluation_2a_1, 3818, 0, 6656)
TUNABLE_PARAM(Search_static_evaluation_1a_1, -39852, -167424, 0)
TUNABLE_PARAM(Search_static_evaluation_1a_2, 17343, 0, 79872)
TUNABLE_PARAM(Search_static_evaluation_1a_3, 11351, 0, 19968)
TUNABLE_PARAM(Search_static_evaluation_1a_4, 1328, 0, 2560)
TUNABLE_PARAM(Search_tt_lookup2_1, -1116, -2354, 0)
TUNABLE_PARAM(Search_tt_lookup1_1, 28, 0, 58)
TUNABLE_PARAM(Search_tt_lookup1_2, 90, 0, 174)
TUNABLE_PARAM(Search_tt_lookup1_3, 1246, 0, 2010)
TUNABLE_PARAM(YaneuraOuWorker_clear3_1, 2762, 0, 5520)
TUNABLE_PARAM(YaneuraOuWorker_clear2_1, -812, -1326, 0)
TUNABLE_PARAM(aspiration_window_1, 28, 0, 46)
TUNABLE_PARAM(aspiration_window_2, 9172, 1, 13584)
TUNABLE_PARAM(lowPlyHistory_fill_1, 85, 0, 168)
TUNABLE_PARAM(update_correction_history2_1, 112, 0, 240)
TUNABLE_PARAM(update_correction_history2_2, 63, 0, 110)
TUNABLE_PARAM(update_correction_history1_1, 189, 0, 362)
TUNABLE_PARAM(update_correction_history_nonPawnWeight_1, 139, 0, 324)
TUNABLE_PARAM(correction_value_1, 6540, 0, 14988)
TUNABLE_PARAM(correction_value_2, 5808, 0, 14846)
TUNABLE_PARAM(correction_value_3, 8884, 0, 21950)
TUNABLE_PARAM(correction_value_4, 13836, 0, 28062)
