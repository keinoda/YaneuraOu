...
TUNABLE_PARAM(Search_fail_low_quiet_bonus_2, 108, 0, 216)
...
TUNABLE_PARAM(Search_Decrease_reduction_for_PvNodes_3_2, 28147, 0, 56294)
...
TUNABLE_PARAM(Search_Extensions2_1, 278065, 0, 556130)
TUNABLE_PARAM(Search_Extensions1_1, 73, 0, 146)
TUNABLE_PARAM(Search_Extensions1_2, 117, 0, 234)
TUNABLE_PARAM(Search_Extensions1_3, 33, 0, 66)
...
TUNABLE_PARAM(Search_Continuation_history_based_pruning1_3, 3593, 0, 7186)
...
TUNABLE_PARAM(Search_futility_1_5, 91703, 0, 183406)
...
TUNABLE_PARAM(aspiration_window_2, 6792, 0, 13584)
