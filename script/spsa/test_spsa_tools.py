...
class SourceContractTests(unittest.TestCase):
    ...
    def test_q8_parameter_contract(self):
        ...
        parameters_by_name = {parameter.name: parameter for parameter in parameters}
        expected = {
            "Search_static_evaluation_2a_1": (3818, 0, 6656),
            "Search_static_evaluation_1a_1": (-39852, -167424, 0),
            "Search_static_evaluation_1a_2": (17343, 0, 79872),
            "Search_static_evaluation_1a_3": (11351, 0, 19968),
            "Search_static_evaluation_1a_4": (1328, 0, 2560),
            "MovePicker_low_ply_history_score_1": (1853, 0, 4096),
            "MovePicker_quiet_score_1": (461, 0, 1024),
            "MovePicker_quiet_score_2": (488, 0, 1024),
            "MovePicker_capture_score_1": (2215, 0, 3584),
        }
    ...
    def test_generated_params_have_exact_format_and_no_not_used(self):
        ...
        self.assertEqual(lines[0], "QSearch_SEE_pruning_1,int,-63,-146,0,7.3,0.002")
        self.assertIn("Search_fail_low_quiet_bonus_13,int,1338,0,2800,140,0.002", lines)
        self.assertEqual(
            lines[-1], "MovePicker_capture_score_1,int,2215,0,3584,179.2,0.002"
        )
...
class SourceContractValidationTests(TemporaryRepositoryTestCase):
    ...
    def test_rejects_non_integer_macro_value(self):
        self.replace_in_search_source(
            ...
            "TUNABLE_PARAM(QSearch_SEE_pruning_1, -63.5, -146, 0)",
        )
    ...
    def test_rejects_invalid_range_and_out_of_range_default(self):
        self.replace_in_search_source(
            "TUNABLE_PARAM(QSearch_SEE_pruning_1, -63, -146, 0)",
            "TUNABLE_PARAM(QSearch_SEE_pruning_1, -63, 0, -146)",
        )
