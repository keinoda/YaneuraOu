...
**→ 実施済み**: 規則は docs/branch-policy.md として制定(2026-07-12)、
台帳は docs/branches.md を作成(2026-07-14)。なお P2 実績の
「`archive/` タグ化」方式はタグ一覧を占有する問題があったため、
隠し名前空間 `refs/archive/*` への退避に変更した(branch-policy.md §5)。
